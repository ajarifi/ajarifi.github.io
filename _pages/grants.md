...
<p style="margin-bottom: 1.5cm;"></p>
  ...
  <details>
    <summary>Scholarships</summary>
      <ol reversed>
        <li> <b>Japanese Government (MEXT) Scholarship, Doctoral program </b><br>
          <button class="btn--article-blue">Scholarship</button> A. J. Arifi. Osaka University, Japan. <br>
          Period: 2017–2020 (3 years).
        </li>
      
        <li> <b>Japanese Government (MEXT) Scholarship, Master's program </b><br>
          <button class="btn--article-blue">Scholarship</button> A. J. Arifi. Osaka University, Japan. <br>
          Period: 2015–2017 (2 years).
        </li>
      
        <li> <b>Tanoto Foundation Scholarship, Bachelor's program</b> <br>
          <button class="btn--article-blue">Scholarship</button> A. J. Arifi. Universitas Indonesia, Indonesia. <br>
          Period: 2012–2015 (3 years).
        </li>
      </ol>
  </details>
